        ...
        <div class="result-content">
          ...
          <div class="info-grid">
            ...
            <div class="info-item">
              ...
              <span class="value">{{ stockData.current_price }}</span>
            </div>
            <div class="info-item">
              <span class="label">今日开盘：</span>
              <span class="value">{{ stockData.today_open }}</span>
            </div>
            <div class="info-item">
              <span class="label">昨日收盘：</span>
              <span class="value">{{ stockData.yesterday_close }}</span>
            </div>
            <div class="info-item">
              <span class="label">今日最高：</span>
              <span class="value">{{ stockData.today_high }}</span>
            </div>
            <div class="info-item">
              <span class="label">今日最低：</span>
              <span class="value">{{ stockData.today_low }}</span>
            </div>
            <div class="info-item">
            ...
            <div class="info-item">
              ...
              <span class="value">{{ stockData.total_amount }}</span>
            </div>
            <div class="info-item">
              <span class="label">价格变动：</span>
              <span class="value">{{ stockData.price_change }}</span>
            </div>
            <div class="info-item">
